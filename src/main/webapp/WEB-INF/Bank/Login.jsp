...
<body>
<div class="wrapper">
    <form action="${pageContext.request.contextPath}/MainMenu" method="post">
        <div class="loginBox">
            <div class="loginBoxCenter">
                <input type="hidden" id="errorInfo" value="${param.errorInfo}">
                ...
                <p><input type="text" id="username" name="username" class="loginInput" autofocus="autofocus"
                          required="required" value="${cookie.get("username").value}"
                ...
                <p><input type="password" id="password" name="password" class="loginInput" required="required"
                          placeholder="请输入密码" value="${cookie.get("password").value}"/></p>
            ...
            <div class="loginBoxButtons">
                ...
                <div><a class="register" href="${pageContext.request.contextPath}/register"> 新用户注册</a></div>
            </div>
        </div>
    </form>
</div>
